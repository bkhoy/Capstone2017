...
function updateDescription() {
    ...
    var description = "This device is located in " + currDevice.city + ", " + currDevice.country + ". ";
    description += "It was deployed on " + new Date(currDevice.placementDate).toLocaleDateString() + ".";
